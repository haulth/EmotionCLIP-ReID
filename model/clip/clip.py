...
try:
    ...
    Compose = Resize = CenterCrop = ToTensor = Normalize = None
...
def _transform(n_px):
    if Compose is None:
        raise ImportError("torchvision is required for clip._transform(); EmotionCLIP uses datasets.FaceSafeTransform instead.")
    return Compose([
